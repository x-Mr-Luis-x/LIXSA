...
module.exports = {
	...
	execute: async (client, message) => {
		...
		const grass = '<:gressxd:919106822336548924>'; // https://cdn.discordapp.com/emojis/897167292591394856.png
		const square = '<:squidgamesquare:919106837687705600>'; // https://cdn.discordapp.com/emojis/897165380873752576.png
		const greenGirl = '<:girlfromback:919106854452350976>'; // https://cdn.discordapp.com/emojis/897166943335874570.png
		const redGirl = '<:girlfromfront:919106872416546836>'; // https://cdn.discordapp.com/emojis/897166451125919754.png
		const greenLine = '<:greenline:919106887264391169> '; // https://cdn.discordapp.com/emojis/897168188721213481.png
		const redLine = '<:redline:919106899343978496>'; // https://cdn.discordapp.com/emojis/897168818634383370.png
		const you = '<:mainchar:919106912723816468>'; // https://cdn.discordapp.com/emojis/897167494018654230.png
		const triangle = '<:squidgametriangle:919106924312670208>'; // https://cdn.discordapp.com/emojis/897165507139076116.png
		...
		function update(die, win) {
			if(win === true) {
				...
				message.channel.send('Ganastes :D');
			}
			if(die === true) {
				game.stop();
				gameEnded = true;
